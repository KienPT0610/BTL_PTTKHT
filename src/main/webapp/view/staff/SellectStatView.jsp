...
<div class="main-content">
    ...
    <div class="main-header">
        <h5 class="m-0 text-secondary">Trang chọn kiểu thống kê</h5>
    ...
    <div class="main-body">
        <div class="welcome-box">
            <h1>Chức năng xem thống kê</h1>
            <p>Hãy chọn thể loại thống kê bạn muốn xem</p>

            <a href="${pageContext.request.contextPath}/view/staff/SupplierStatView.jsp"
               class="btn btn-primary btn-stat shadow-sm">
                <i class="bi bi-bar-chart-fill"></i> Thống kê nhà cung cấp theo lượng hàng nhập
            </a>
        </div>
    </div>
</div>
